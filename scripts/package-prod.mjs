...
const distDir = path.join(root, "dist", "humanresource");
...
console.log("Packaging humanresource production build...");
...
console.log(distDir);
console.log(`Run it with: cd dist\\humanresource && node server.js`);
