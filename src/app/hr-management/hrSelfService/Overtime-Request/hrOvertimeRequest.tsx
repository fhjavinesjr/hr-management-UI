                    ...
                    >
                      ...
                      <div className={styles.formGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setForm({
                              ...form,
                              authorityReference: sanitizeText(e.target.value, 100),
                            })
                          }
                          className={styles.inputField}
                        ...
                        <div className={styles.formGroup}>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setForm({
                                ...form,
                                emergencyJustification: sanitizeText(e.target.value, 500),
                              })
                            }
                            className={styles.inputField}
                            rows={2}
                      ...
                      <div className={styles.formGroup}>
                        ...
                        <textarea
                          value={form.purpose}
                          onChange={(e) =>
                            setForm({ ...form, purpose: sanitizeText(e.target.value, 500) })
                          }
                          className={styles.inputField}
                          rows={3}
                          required
